...
} from "next/dist/build/segment-config/pages/pages-segment-config";
...
export declare function getRSCModuleInformation(
	source: string,
...
export declare function getAppPageStaticInfo({
	pageFilePath,
	nextConfig,
	isDev,
	page,
}: GetPageStaticInfoParams): Promise<AppPageStaticInfo>;
export declare function getPagesPageStaticInfo({
	pageFilePath,
	nextConfig,
	isDev,
	page,
 ...
 */
export declare function getPageStaticInfo(
