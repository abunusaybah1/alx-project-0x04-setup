import { TurborepoAccessTraceResult } from "next/dist/build/turborepo-access-trace/result";
/**
 ...
 */
export declare function turborepoTraceAccess<T>(
	f: () => T | Promise<T>,
 ...
 */
export declare function writeTurborepoAccessTraceResult({
	distDir,
	traces,
}: {
	distDir: string;
