...
import type { FunctionsConfigManifest } from "next/dist/build";
...
export declare function isMiddlewareFilename(
	file?: string | null
): file is "middleware" | "proxy" | "src/middleware" | "src/proxy";
export declare function isInstrumentationHookFilename(
	file?: string | null
): file is "instrumentation" | "src/instrumentation";
...
export declare function collectRoutesUsingEdgeRuntime(
	input: PageInfos
 ...
 */
export declare function printBuildErrors(
	entrypoints: TurbopackResult,
	isDev: boolean
): void;
export declare function printTreeView(
	lists: {
...
export declare function printCustomRoutes({
	redirects,
	rewrites,
	headers,
}: CustomRoutes): void;
...
export declare function isPageStatic({
	dir,
	page,
	distDir,
	configFileName,
	...
	cacheLifeProfiles?: {
		[
			profile: string
		]: import("next/dist/server/use-cache/cache-life").CacheLife;
	};
 ...
 */
export declare function reduceAppConfig(
	segments: Pick<AppSegment, "config">[]
): ReducedAppConfig;
export declare function hasCustomGetInitialProps({
	page,
	distDir,
	checkingApp,
	sriEnabled,
...
export declare function getDefinedNamedExports({
	page,
	distDir,
	sriEnabled,
}: {
...
export declare function detectConflictingPaths(
	combinedPages: string[],
	ssgPages: Set<string>,
	additionalGeneratedSSGPaths: Map<string, string[]>
): void;
export declare function copyTracedFiles(
	dir: string,
	distDir: string,
...
export declare function isCustomErrorPage(
	page: string
): page is "/500" | "/404";
export declare function isMiddlewareFile(
	file: string
): file is "/middleware" | "/src/middleware" | "/proxy" | "/src/proxy";
export declare function isProxyFile(
	file: string
): file is "/proxy" | "/src/proxy";
export declare function isInstrumentationHookFile(
	file: string
): file is "/instrumentation" | "/src/instrumentation";
export declare function getPossibleInstrumentationHookFilenames(
	folder: string,
	extensions: string[]
): string[];
export declare function getPossibleMiddlewareFilenames(
	folder: string,
	extensions: string[]
): string[];
...
export declare function getSupportedBrowsers(
	dir: string,
	isDevelopment: boolean
): string[];
export declare function shouldUseReactServerCondition(
	layer: WebpackLayerName | null | undefined
): boolean;
export declare function isWebpackClientOnlyLayer(
	layer: WebpackLayerName | null | undefined
): boolean;
export declare function isWebpackDefaultLayer(
	layer: WebpackLayerName | null | undefined
): boolean;
export declare function isWebpackBundledLayer(
	layer: WebpackLayerName | null | undefined
): boolean;
export declare function isWebpackAppPagesLayer(
	layer: WebpackLayerName | null | undefined
): boolean;
export declare function collectMeta({
	status,
	headers,
}: {
	status?: number;
