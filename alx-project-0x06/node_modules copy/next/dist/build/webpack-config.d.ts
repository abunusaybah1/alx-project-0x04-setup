...
export declare function attachReactRefresh(
...
export declare function loadProjectInfo({
	dir,
	config,
	dev,
}: {
...
export declare function getCacheDirectories(
	...
	dir: string,
	{
		...
		clientRouterFilters?: {
			staticFilter: ReturnType<
				import("next/dist/shared/lib/bloom-filter.js").BloomFilter["export"]
			>;
