...
} from "next/dist/shared/lib/server-inserted-html.shared-runtime";
/**
 *
 ...
 */
export declare function useSelectedLayoutSegments(
 ...
 */
export declare function useSelectedLayoutSegment(
	parallelRouteKey?: string
): string | null;
export { unstable_isUnrecognizedActionError } from "next/dist/client/components/unrecognized-action-error";
export {
	notFound,
	forbidden,
	unauthorized,
