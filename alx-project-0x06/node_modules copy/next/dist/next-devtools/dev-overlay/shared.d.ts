...
import type { DebugInfo } from "next/dist/next-devtools/shared/types";
import type { DevIndicatorServerState } from "next/dist/server/dev/dev-indicator-server-state";
import type { CacheIndicatorState } from "next/dist/next-devtools/dev-overlay/cache-indicator";
...
export declare const ACTION_RENDERING_INDICATOR_SHOW =
	"rendering-indicator-show";
export declare const ACTION_RENDERING_INDICATOR_HIDE =
	"rendering-indicator-hide";
...
export declare const STORAGE_KEY_PANEL_POSITION_PREFIX =
	"__nextjs-dev-tools-panel-position";
export declare const STORE_KEY_PANEL_SIZE_PREFIX =
	"__nextjs-dev-tools-panel-size";
export declare const STORE_KEY_SHARED_PANEL_SIZE =
	"__nextjs-dev-tools-shared-panel-size";
export declare const STORE_KEY_SHARED_PANEL_LOCATION =
	"__nextjs-dev-tools-shared-panel-location";
export declare const ACTION_DEVTOOL_UPDATE_ROUTE_STATE =
...
export declare const INITIAL_OVERLAY_STATE: Omit<
	OverlayState,
	"isErrorOverlayOpen" | "routerType"
>;
export declare function useErrorOverlayReducer(
	routerType: "pages" | "app",
	getOwnerStack: (error: Error) => string | null | undefined,
	isRecoverableError: (error: Error) => boolean,
	enableCacheIndicator: boolean
): [OverlayState, import("react").ActionDispatch<[action: DispatcherEvent]>];
export {};
