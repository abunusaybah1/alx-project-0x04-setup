import type { StackFrame } from "next/dist/server/lib/parse-stack";
...
export declare function ignoreListAnonymousStackFramesIfSandwiched(
 ...
 */
export declare function getOriginalCodeFrame(
