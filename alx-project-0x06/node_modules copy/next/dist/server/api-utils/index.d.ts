...
export declare function wrapApiHandler<T extends (...args: any[]) => any>(
	page: string,
	handler: T
): T;
/**
 ...
 */
export declare function sendStatusCode(
	res: NextApiResponse,
	statusCode: number
): NextApiResponse<any>;
/**
...
export declare function checkIsOnDemandRevalidate(
...
export declare function clearPreviewData<T>(
 ...
 */
export declare function setLazyProp<T>(
	{ req }: LazyProps,
	prop: string,
	getter: () => T
): void;
