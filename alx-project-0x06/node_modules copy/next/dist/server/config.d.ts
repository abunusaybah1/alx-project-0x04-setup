import { type PHASE_TYPE } from "next/dist/shared/lib/constants";
import type {
	ExperimentalConfig,
	NextConfigComplete,
	NextConfig,
...
export declare function warnOptionHasBeenDeprecated(
	config: NextConfig,
	nestedPropertyKey: string,
	reason: string,
	silent: boolean
): boolean;
export declare function warnOptionHasBeenMovedOutOfExperimental(
	config: NextConfig,
