...
export declare function getSharp(
...
export declare function extractEtag(
...
export declare function getPreviouslyCachedImageOrNull(
...
export declare function fetchExternalImage(
	href: string,
	dangerouslyAllowLocalIP: boolean,
	count?: number
): Promise<ImageUpstream>;
export declare function fetchInternalImage(
	href: string,
...
export declare function imageOptimizer(
