...
import type { RouteModule } from "next/dist/server/route-modules/route-module";
 ...
 */
export declare function loadManifestWithRetries<T extends object>(
	manifestPath: string,
	attempts?: number
 ...
 */
export declare function tryLoadManifestWithRetries<T extends object>(
	manifestPath: string,
	attempts?: number
 ...
 * Load manifest file with retries, defaults to 3 attempts.
 */
export declare function evalManifestWithRetries<T extends object>(
	manifestPath: string,
	attempts?: number
): Promise<DeepReadonly<T>>;
declare function loadComponentsImpl<N = any>({
	distDir,
	page,
	isAppPath,
	isDev,
