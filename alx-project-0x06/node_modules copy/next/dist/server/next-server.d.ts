...
import type { RouteMatch } from "next/dist/server/route-matches/route-match";
...
import type { PagesAPIRouteMatch } from "next/dist/server/route-matches/pages-api-route-match";
...
> {
	...
	protected loadInstrumentationModule(): Promise<
		| import("next/dist/server/instrumentation/types").InstrumentationModule
		| undefined
	>;
	...
	protected imageOptimizer(
		req: NodeNextRequest,
		res: NodeNextResponse,
		paramsResult: import("next/dist/server/image-optimizer").ImageParamsResult,
	...
	protected renderErrorToResponseImpl(
		ctx: RequestContext<NodeNextRequest, NodeNextResponse>,
		err: Error | null
	): Promise<{
		body: RenderResult;
	...
	protected getFallbackErrorComponents(
		_url?: string
	): Promise<LoadComponentsReturnType | null>;
	protected instrumentationOnRequestError(
