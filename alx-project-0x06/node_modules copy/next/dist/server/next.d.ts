...
import type { default as NextNodeServer } from "next/dist/server/next-server";
import type { ServerFields } from "next/dist/server/lib/router-utils/setup-dev-bundler";
...
export declare class NextServer implements NextWrapperServer {
	...
	logErrorWithOriginalStack(err: unknown, type: string): Promise<any>;
	revalidate(
		...args: Parameters<NextWrapperServer["revalidate"]>
	): Promise<void>;
	render(...args: Parameters<NextWrapperServer["render"]>): Promise<void>;
	renderToHTML(
		...args: Parameters<NextWrapperServer["renderToHTML"]>
	): Promise<string | null>;
	renderError(
		...args: Parameters<NextWrapperServer["renderError"]>
	): Promise<void>;
	renderErrorToHTML(
