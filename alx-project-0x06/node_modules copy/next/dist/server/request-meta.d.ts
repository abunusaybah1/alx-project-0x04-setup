...
import type { PagesDevOverlayBridgeType } from "next/dist/next-devtools/userspace/pages/pages-dev-overlay-setup";
 ...
 */
export declare function getRequestMeta(
	req: NextIncomingMessage,
	key?: undefined
): RequestMeta;
export declare function getRequestMeta<K extends keyof RequestMeta>(
	req: NextIncomingMessage,
	key: K
): RequestMeta[K];
/**
 ...
 */
export declare function setRequestMeta(
	req: NextIncomingMessage,
	meta: RequestMeta
): RequestMeta;
/**
 ...
 * @returns the mutated request metadata
 */
export declare function addRequestMeta<K extends keyof RequestMeta>(
 ...
 * @returns the mutated request metadata
 */
export declare function removeRequestMeta<K extends keyof RequestMeta>(
	request: NextIncomingMessage,
	key: K
): RequestMeta;
