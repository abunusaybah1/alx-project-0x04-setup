...
import type { DynamicParamTypesShort } from "next/dist/shared/lib/app-router-types";
import type AppPageRouteModule from "next/dist/server/route-modules/app-page/module";
 ...
 */
export type OpaqueFallbackRouteParamEntries = ReturnType<
	OpaqueFallbackRouteParams["entries"]
> extends MapIterator<[infer K, infer V]>
	? ReadonlyArray<[K, V]>
	: never;
/**
 ...
 */
export declare function createOpaqueFallbackRouteParams(
 ...
 * @returns the opaque fallback route params
 */
export declare function getFallbackRouteParams(
	page: string,
