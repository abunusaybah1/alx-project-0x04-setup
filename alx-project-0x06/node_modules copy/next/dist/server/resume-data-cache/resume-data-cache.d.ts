...
} from "next/dist/server/resume-data-cache/cache-store";
/**
 ...
 * 'null' if empty
 */
export declare function stringifyResumeDataCache(
 ...
 */
export declare function createRenderResumeDataCache(
