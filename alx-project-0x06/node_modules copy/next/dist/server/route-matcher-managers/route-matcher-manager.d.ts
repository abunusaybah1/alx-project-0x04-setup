...
import type { RouteMatcherProvider } from "next/dist/server/route-matcher-providers/route-matcher-provider";
import type { LocaleAnalysisResult } from "next/dist/server/lib/i18n-provider";
