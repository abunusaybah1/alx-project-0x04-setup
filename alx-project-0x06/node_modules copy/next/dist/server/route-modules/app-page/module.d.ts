...
} from "next/dist/server/app-render/app-render";
import {
	RouteModule,
...
>;
export declare class AppPageRouteModule extends RouteModule<
	AppPageRouteDefinition,
	AppPageUserlandModule
> {
	private matchers;
	match(
		...
		readonly experimentalBypassFor?:
			| readonly (
					| {
		...
		readonly fallbackRevalidate:
			| import("next/dist/server/lib/cache-control").Revalidate
			| undefined;
		...
		readonly renderingMode:
			| import("next/dist/build/rendering-mode").RenderingMode
			| undefined;
...
declare const vendored: {
	"react-rsc":
		| typeof import("next/dist/server/route-modules/app-page/vendored/rsc/entrypoints")
		| undefined;
	"react-ssr":
		| typeof import("next/dist/server/route-modules/app-page/vendored/ssr/entrypoints")
		| undefined;
