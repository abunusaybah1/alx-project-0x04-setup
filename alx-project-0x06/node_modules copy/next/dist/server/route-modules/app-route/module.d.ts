...
import type { AppRouteRouteDefinition } from "next/dist/server/route-definitions/app-route-route-definition";
...
} from "next/dist/server/route-modules/route-module";
import { type WorkStoreContext } from "next/dist/server/async-storage/work-store";
import { type HTTP_METHOD } from "next/dist/server/web/http";
import * as serverHooks from "next/dist/client/components/hooks-server-context";
import * as sharedModules from "next/dist/server/route-modules/app-route/shared-modules";
import type { RenderOptsPartial } from "next/dist/server/app-render/types";
...
export type AppRouteModule =
	typeof import("next/dist/build/templates/app-route");
 ...
 */
export declare class AppRouteRouteModule extends RouteModule<
...
> {
	 ...
	 */
	readonly workUnitAsyncStorage: import("next/dist/server/app-render/work-unit-async-storage.external").WorkUnitAsyncStorage;
	/**
	 * A reference to the static generation async storage.
	 */
	readonly workAsyncStorage: import("next/dist/server/app-render/work-async-storage.external").WorkAsyncStorage;
	/**
	 ...
	 * cookies.
	 */
	readonly actionAsyncStorage: import("next/dist/server/app-render/action-async-storage.external").ActionAsyncStorage;
	readonly resolvedPagePath: string;
 ...
 *          methods are static
 */
export declare function hasNonStaticMethods(
