...
} from "next/dist/shared/lib/entry-constants";
...
export declare const FUNCTIONS_CONFIG_MANIFEST =
	"functions-config-manifest.json";
export declare const SUBRESOURCE_INTEGRITY_MANIFEST =
...
export declare const TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST =
	"_clientMiddlewareManifest.json";
export declare const TURBOPACK_CLIENT_BUILD_MANIFEST =
	"client-build-manifest.json";
export declare const DEV_CLIENT_MIDDLEWARE_MANIFEST =
...
export declare const MIDDLEWARE_REACT_LOADABLE_MANIFEST =
	"middleware-react-loadable-manifest";
export declare const INTERCEPTION_ROUTE_REWRITE_MANIFEST =
...
export declare const CLIENT_STATIC_FILES_RUNTIME_REACT_REFRESH =
	"react-refresh";
