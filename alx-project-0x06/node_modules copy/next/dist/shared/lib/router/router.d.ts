...
export declare function matchesMiddleware<T extends FetchDataOutput>(
...
export type PrivateRouteInfo =
	| (Omit<CompletePrivateRouteInfo, "styleSheets"> & {
			initial: true;
	  })
...
export default class Router implements BaseRouter {
	...
	fetchComponent(
		route: string
	): Promise<import("next/dist/client/page-loader").GoodPageCache>;
