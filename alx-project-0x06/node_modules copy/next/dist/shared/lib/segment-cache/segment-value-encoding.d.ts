import type { Segment as FlightRouterStateSegment } from "next/dist/shared/lib/app-router-types";
type Opaque<K, T> = T & {
	__brand: K;
};
...
export declare function createSegmentRequestKeyPart(
	segment: FlightRouterStateSegment
): SegmentRequestKeyPart;
export declare function appendSegmentRequestKeyPart(
	parentRequestKey: SegmentRequestKey,
	parallelRouteKey: string,
	childRequestKeyPart: SegmentRequestKeyPart
): SegmentRequestKey;
export declare function convertSegmentPathToStaticExportFilename(
	segmentPath: string
): string;
export {};
